    ...
    <div class="main-wrapper" v-show='pageIsShow' :style="{ 'background-image': 'url(' + img + ')'}">
        ...
        <div class="content">
            ...
            <div class="content_contents">
                <div class="content_contents_z">
                    <div class="content_contents_item">
                        <p>{{waterTempHS}}mg/L</p>
                        <p>TOC</p>
                    </div>
                    <div class="content_contents_item">
                        <p>{{waterTempHSd}}mg/L</p>
                        <p>COD</p>
                    </div>
                </div>
                ...
                <div class="content_contents_z2">
                    <div class="content_contents_z2_item">
                        <p><img src="../../assets/wendu.png"></p>
                        <p>{{wendus}}℃</p>
                    </div>
                    <div class="content_contents_z2_item">
                        <p><img src="../../assets/qiya.png" style="width:0.5rem;"></p>
                        <p>0.5Pa</p>
                    </div>
                </div>
                <div class="content_bottom" @click="onOffMethod">
...
import img1 from "../../assets/szjc_bg.png"; // 白天阴
import img2 from "../../assets/szjc_bg.png"; // 夜晚阴
import img3 from "../../assets/szjc_bg.png"; // 夜晚晴
import img4 from "../../assets/szjc_bg.png"; // 白天晴
